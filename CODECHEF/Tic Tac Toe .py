...
def checkwin(a,c):
    p1=[]
    if a[0]==c and a[1]==c and a[2]==c:
        return True
    if a[3]==c and a[4]==c and a[5]==c:
        return True
    if a[6]==c and a[7]==c and a[8]==c:
        return True

    #for column win
    if a[0]==c and a[3]==c and a[6]==c:
        return True
    if a[1]==c and a[4]==c and a[7]==c:
        return True
    if a[2]==c and a[5]==c and a[8]==c:
        return True

    #for diagonal win
    if a[0]==c and a[4]==c and a[8]==c:
        return True
    if a[2]==c and a[4]==c and a[6]==c:
        return True
...
def check(a):
    ...
    if (xwin and owin) == True:
        return 3
    if xwin==True and xc==oc:
        return 3
    if owin==True and xc>oc:
        return 3
    ...
    if owin==True and xwin==False:
        return 1
    if _c==0 and xwin==False and owin==False:
        return 1
